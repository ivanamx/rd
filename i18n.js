    ...
    const TRANSLATIONS = {
        es: {
            ...
            radio: {
                ...
                mobileIdleTitle: 'Radio Saltillo',
                mobileTapPlay: 'Toca play',
                mobileLive: 'En vivo',
                mobileIdentifying: 'Identificando…',
                ...
                producerProfileTitle: 'Mi perfil de productor',
                ...
                producerNowPlayingTitle: 'Ahora en la estación',
                producerNowIdle: 'La radio está en pausa',
                producerNowPaused: 'En pausa',
                producerNowStream: 'Programación de la estación',
                producerNowLive: 'Sesión en vivo',
                producerNowQueued: 'Pista en cola',
                producerElapsed: 'Transcurrido',
                producerRemaining: 'Restante',
                producerLiveDuration: 'Tiempo en vivo',
                producerQueueCount: '{{count}} en cola',
                producerQueueEmpty: 'No hay pistas en cola',
                producerQueueNext: 'Siguiente',
                producerQueuePlaying: 'Sonando',
                producerQueueUpNext: 'En cola',
                producerCtrlPlay: 'Reproducir',
                producerCtrlPause: 'Pausar',
                producerCtrlSkip: 'Siguiente pista',
                producerCtrlStopLive: 'Cortar en vivo',
                producerCtrlClearQueue: 'Vaciar cola',
                producerCtrlRemove: 'Quitar de la cola',
                producerSkipped: 'Pista omitida',
                producerQueueCleared: 'Cola vaciada',
                producerRemovedFromQueue: 'Pista eliminada de la cola',
                producerAdded: '{{count}} pista(s) agregada(s) a la cola de la radio',
                producerLogout: 'Cerrar sesión',
                producerGoLive: 'Ir en vivo',
                producerLiveStandby: 'STANDBY',
                producerLiveOnAir: 'EN VIVO',
                producerLiveTitle: 'Broadcasting en vivo',
                producerLiveSubtitle: 'Transmite audio en directo a Radio Saltillo FM',
                producerLiveReady: 'Listo para transmitir',
                producerLiveConnecting: 'Solicitando acceso al micrófono…',
                producerLiveActive: 'Transmitiendo a la estación',
                producerLiveStopped: 'Transmisión finalizada',
                producerLiveStart: 'Iniciar transmisión',
                producerLiveStop: 'Terminar transmisión',
                producerLiveMute: 'Silenciar',
                producerLiveUnmute: 'Activar micrófono',
                producerLiveNowPlaying: 'Transmisión en vivo',
                producerLiveStarted: 'En vivo en Radio Saltillo FM',
                producerLiveMicError: 'No se pudo acceder al micrófono',
                producerLiveNote: 'Demo local: el micrófono se enruta al reproductor de radio en este navegador. Sin backend aún.'
            },
            guia: {
                titleMain: 'ÚNETE',
            ...
            productos: {
                ...
                artistsTitle: 'Artistas y bandas locales',
                artistsDesc: 'Conoce a creadores y bandas de Saltillo. Talento verificado de la ciudad.',
                creatorArtist: 'Artista',
                creatorBand: 'Banda',
                statTracksLabel: 'Canciones',
                statVenuesLabel: 'Lugares',
                creatorsPrev: 'Anterior',
                creatorsNext: 'Siguiente',
                creatorsPageInfo: 'Página {{page}} de {{total}}',
                ...
                profileHeroMute: 'Silenciar video del perfil',
                profileHeroUnmute: 'Activar audio del video',
                profileLogout: 'Salir',
                ...
                profileCalendar: 'Calendario',
                profileCalTitle: 'Calendario de shows',
                profileCalMonth: 'Mes',
                profileCalWeek: 'Semana',
                profileCalNoShows: 'Sin shows en este periodo',
            ...
            bandas: {
                ...
                publicBack: 'Volver al inicio',
                publicReserve: 'Reservar banda',
                publicNotFound: 'No encontramos esta banda.',
        ...
        en: {
            ...
            radio: {
                ...
                mobileIdleTitle: 'Radio Saltillo',
                mobileTapPlay: 'Tap play',
                mobileLive: 'Live',
                mobileIdentifying: 'Identifying…',
                playTitle: 'Play',
                stopTitle: 'Stop',
                cardGaryBadge: 'Desert Rock · 5.0 ★',
                ...
                producerProfileTitle: 'My producer profile',
                ...
                producerNowPlayingTitle: 'On air now',
                producerNowIdle: 'Radio is paused',
                producerNowPaused: 'Paused',
                producerNowStream: 'Station programming',
                producerNowLive: 'Live session',
                producerNowQueued: 'Queued track',
                producerElapsed: 'Elapsed',
                producerRemaining: 'Remaining',
                producerLiveDuration: 'Live duration',
                producerQueueCount: '{{count}} in queue',
                producerQueueEmpty: 'No tracks in queue',
                producerQueueNext: 'Up next',
                producerQueuePlaying: 'Playing',
                producerQueueUpNext: 'Queued',
                producerCtrlPlay: 'Play',
                producerCtrlPause: 'Pause',
                producerCtrlSkip: 'Skip track',
                producerCtrlStopLive: 'End live',
                producerCtrlClearQueue: 'Clear queue',
                producerCtrlRemove: 'Remove from queue',
                producerSkipped: 'Track skipped',
                producerQueueCleared: 'Queue cleared',
                producerRemovedFromQueue: 'Track removed from queue',
                producerAdded: '{{count}} track(s) added to the radio queue',
                producerLogout: 'Log out',
                producerGoLive: 'Go live',
                producerLiveStandby: 'STANDBY',
                producerLiveOnAir: 'ON AIR',
                producerLiveTitle: 'Live broadcasting',
                producerLiveSubtitle: 'Stream live audio to Radio Saltillo FM',
                producerLiveReady: 'Ready to broadcast',
                producerLiveConnecting: 'Requesting microphone access…',
                producerLiveActive: 'Broadcasting to the station',
                producerLiveStopped: 'Broadcast ended',
                producerLiveStart: 'Start broadcast',
                producerLiveStop: 'End broadcast',
                producerLiveMute: 'Mute',
                producerLiveUnmute: 'Unmute mic',
                producerLiveNowPlaying: 'Live broadcast',
                producerLiveStarted: 'Live on Radio Saltillo FM',
                producerLiveMicError: 'Could not access microphone',
                producerLiveNote: 'Local demo: microphone is routed to the radio player in this browser. No backend yet.'
            },
            guia: {
                titleMain: 'JOIN',
                titleSub: 'THE SCENE',
            ...
            productos: {
                ...
                artistsTitle: 'Local artists & bands',
                artistsDesc: 'Meet creators and bands from Saltillo. Verified local talent.',
                creatorArtist: 'Artist',
                creatorBand: 'Band',
                statTracksLabel: 'Tracks',
                statVenuesLabel: 'Venues',
                creatorsPrev: 'Previous',
                creatorsNext: 'Next',
                creatorsPageInfo: 'Page {{page}} of {{total}}',
                cartTitle: 'Your cart',
                ...
                profileHeroMute: 'Mute profile video',
                profileHeroUnmute: 'Unmute profile video',
                ...
                profileCalTitle: 'Shows calendar',
                profileCalMonth: 'Month',
                profileCalWeek: 'Week',
                profileCalNoShows: 'No shows in this period',
            ...
            bandas: {
                ...
                publicBack: 'Back to home',
                publicReserve: 'Book band',
                publicNotFound: 'We could not find this band.',
