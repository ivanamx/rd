    ...
    const TRANSLATIONS = {
        es: {
            ...
            productos: {
                ...
                metaDescription: 'Marketplace creativo de Saltillo. Playeras, stickers, instrumentos y arte de artistas locales.',
                back: 'Volver',
                searchPlaceholder: 'Buscar productos o artistas...',
                searchAria: 'Buscar productos',
                openCart: 'Abrir carrito de compras',
                heroBadge: 'Marketplace Creativo',
                heroLine1: 'Arte y diseño',
                heroLine2: 'hecho en Saltillo',
                heroSubtitle: 'Productos únicos de artistas locales. Cada compra apoya el talento creativo de nuestra ciudad.',
                ctaProducts: 'Ver productos',
                ctaArtists: 'Conocer artistas',
                statProducts: 'Productos',
                statArtists: 'Artistas',
                statSales: 'Ventas',
                trustShipping: 'Envío en Saltillo',
                trustSecure: 'Pago seguro',
                trustVerified: 'Artistas verificados',
                trustReturns: 'Devolución 7 días',
                catEyebrow: 'Categorías',
                catTitle: 'Encuentra lo que buscas',
                catAll: 'Todos',
                catShirts: 'Playeras',
                catStickers: 'Stickers',
                catInstruments: 'Instrumentos',
                catBranding: 'Branding',
                catArt: 'Arte',
                showing: 'Mostrando {{count}} productos',
                artistsEyebrow: 'Comunidad',
                artistsTitle: 'Artistas locales',
                artistsDesc: 'Conoce a quienes crean cada pieza. Talento verificado de Saltillo.',
                ...
                total: 'Total',
                payNow: 'Pagar ahora',
                payCard: 'Tarjeta / transferencia',
                viewCart: 'Ver carrito · $0',
                viewCartItems: 'Ver carrito ({{count}}) · {{total}}',
                featured: 'Destacado',
                lowStock: '¡Solo {{count}}!',
                byArtist: 'por {{name}}',
                shippingNote: 'MXN · envío local',
                addToCart: 'Agregar al carrito',
                added: 'Agregado',
                quickView: 'Ver detalles de {{name}}',
                verified: 'Artista verificado',
                statProductsLabel: 'Productos',
                statSalesLabel: 'Ventas',
                statRatingLabel: 'Rating',
                modalClose: 'Cerrar',
                modalStock: '{{rating}} · {{stock}} en stock',
                modalLowStock: '¡Pocas unidades disponibles!',
                remove: 'Eliminar',
                decreaseQty: 'Reducir cantidad',
                increaseQty: 'Aumentar cantidad',
                maxStock: 'Stock máximo alcanzado',
                addedToCart: '{{name}} agregado',
                removed: 'Producto eliminado',
                processingPay: 'Procesando pago...',
                thanksPurchase: '¡Gracias por tu compra!',
                login: 'Iniciar sesión',
                loginAria: 'Abrir inicio de sesión',
                loginTitle: 'Inicia sesión',
                loginSubtitle: 'Accede a tu cuenta del marketplace creativo',
                loginIdentifier: 'Email o nombre de banda',
                loginIdentifierPlaceholder: 'tu@email.com o Ej. Los del Desierto',
                ...
                loginClose: 'Cerrar',
                loginDemo: 'Inicio de sesión disponible próximamente',
                loginSuccess: '¡Bienvenido de vuelta!',
                loginError: 'Email, nombre de banda o contraseña incorrectos',
                profileTitle: 'Mi perfil de banda',
                profilePremium: 'Premium',
                profileRating: 'valoraciones',
                profileStatViews: 'Vistas',
                profileStatBookings: 'Reservas',
                profileStatShows: 'Shows',
                profileStatProducts: 'Productos',
                profileInfo: 'Información',
                profileContact: 'Contacto',
                profilePhone: 'WhatsApp',
                profileEmail: 'Email',
                profilePrice: 'Precio por evento',
                profileDuration: 'Duración',
                profileShowDetails: 'Detalles del show',
                profileVenues: 'Lugares tocados',
                profileNoVenues: 'Aún no has agregado lugares',
                profileTracks: 'Muestras de audio',
                profileNoTracks: 'Sube tu primera muestra MP3',
                profileUploadMp3: 'Subir MP3',
                profileUploadMp3Hint: 'Arrastra o haz clic · MP3, máx. 3 MB',
                profileChangePhoto: 'Cambiar foto',
                profileLogout: 'Salir',
                profileClose: 'Cerrar perfil',
                profileOpen: 'Abrir mi perfil',
                profileSaved: 'Perfil actualizado',
                profileUploadError: 'No se pudo subir el archivo. Verifica el formato y tamaño.',
                profileMemberSince: 'Miembro desde',
                profileDashboard: 'Panel de management',
                profileEarningsMonth: 'Ingresos este mes',
                profileEarningsYear: 'Ingresos este año',
                profileEarningsPending: 'Por cobrar',
                profileEarningsAvg: 'Promedio por show',
                profileStageMonth: 'Horas en escena (mes)',
                profileStageYear: 'Horas en escena (año)',
                profileShowsMonth: 'Shows este mes',
                profileShowsYear: 'Shows este año',
                profileVenuesTotal: 'Venues únicos',
                profileVenuesMonth: 'Venues este mes',
                profileVenuesRepeat: 'Tasa de repetición',
                profileTopVenues: 'Top venues',
                profileUpcoming: 'Próximos shows',
                profileRecent: 'Shows recientes',
                profileGallery: 'Galería',
                profileStatusConfirmed: 'Confirmado',
                profileStatusPending: 'Pendiente',
                profileTrendUp: 'vs mes anterior',
                profileHours: 'h',
                profileVenueShows: 'shows',
                profileEditSave: 'Guardar cambios',
                profileUploadGallery: 'Subir foto o video',
                profileUploadGalleryHint: 'JPG, PNG, MP4, WebM · máx. 10 MB',
                profileNoGallery: 'Sube fotos o videos a tu galería',
                profileDescription: 'Descripción',
                profileGenre: 'Género musical',
                profileVenuesHint: 'Separa los lugares con comas',
            ...
            registroBanda: {
                ...
                hintPassword: 'Mínimo 6 caracteres. Junto con el nombre de tu banda, será tu acceso al marketplace.',
        ...
        en: {
            ...
            productos: {
                ...
                metaDescription: 'Saltillo creative marketplace. T-shirts, stickers, instruments and art from local artists.',
                back: 'Back',
                searchPlaceholder: 'Search products or artists...',
                searchAria: 'Search products',
                openCart: 'Open shopping cart',
                heroBadge: 'Creative Marketplace',
                heroLine1: 'Art and design',
                heroLine2: 'made in Saltillo',
                heroSubtitle: 'Unique products from local artists. Every purchase supports creative talent in our city.',
                ctaProducts: 'Browse products',
                ctaArtists: 'Meet artists',
                statProducts: 'Products',
                statArtists: 'Artists',
                statSales: 'Sales',
                trustShipping: 'Shipping in Saltillo',
                trustSecure: 'Secure payment',
                trustVerified: 'Verified artists',
                trustReturns: '7-day returns',
                catEyebrow: 'Categories',
                catTitle: 'Find what you need',
                catAll: 'All',
                catShirts: 'T-shirts',
                catStickers: 'Stickers',
                ...
                artistsEyebrow: 'Community',
                artistsTitle: 'Local artists',
                artistsDesc: 'Meet the creators behind every piece. Verified Saltillo talent.',
                cartTitle: 'Your cart',
                ...
                viewCart: 'View cart · $0',
                viewCartItems: 'View cart ({{count}}) · {{total}}',
                featured: 'Featured',
                lowStock: 'Only {{count}} left!',
                byArtist: 'by {{name}}',
                shippingNote: 'MXN · local shipping',
                addToCart: 'Add to cart',
                added: 'Added',
                quickView: 'View details for {{name}}',
                verified: 'Verified artist',
                statProductsLabel: 'Products',
                statSalesLabel: 'Sales',
                statRatingLabel: 'Rating',
                modalClose: 'Close',
                modalStock: '{{rating}} · {{stock}} in stock',
                modalLowStock: 'Few units left!',
                remove: 'Remove',
                ...
                loginTitle: 'Log in',
                loginSubtitle: 'Access your creative marketplace account',
                loginIdentifier: 'Email or band name',
                loginIdentifierPlaceholder: 'you@email.com or E.g. Los del Desierto',
                ...
                loginClose: 'Close',
                loginDemo: 'Login coming soon',
                loginSuccess: 'Welcome back!',
                loginError: 'Incorrect email, band name or password',
                profileTitle: 'My band profile',
                profilePremium: 'Premium',
                profileRating: 'reviews',
                profileStatViews: 'Views',
                profileStatBookings: 'Bookings',
                profileStatShows: 'Shows',
                ...
                profilePhone: 'WhatsApp',
                profileEmail: 'Email',
                profilePrice: 'Price per event',
                profileDuration: 'Duration',
                profileShowDetails: 'Show details',
                profileVenues: 'Venues played',
                profileNoVenues: 'No venues added yet',
                profileTracks: 'Audio samples',
                profileNoTracks: 'Upload your first MP3 sample',
                profileUploadMp3: 'Upload MP3',
                profileUploadMp3Hint: 'Drag or click · MP3, max 3 MB',
                profileChangePhoto: 'Change photo',
                profileLogout: 'Log out',
                profileClose: 'Close profile',
                profileOpen: 'Open my profile',
                profileSaved: 'Profile updated',
                profileUploadError: 'Could not upload file. Check format and size.',
                profileMemberSince: 'Member since',
                profileDashboard: 'Management dashboard',
                profileEarningsMonth: 'Earnings this month',
                profileEarningsYear: 'Earnings this year',
                profileEarningsPending: 'Pending payment',
                profileEarningsAvg: 'Average per show',
                profileStageMonth: 'Stage hours (month)',
                profileStageYear: 'Stage hours (year)',
                profileShowsMonth: 'Shows this month',
                profileShowsYear: 'Shows this year',
                profileVenuesTotal: 'Unique venues',
                profileVenuesMonth: 'Venues this month',
                profileVenuesRepeat: 'Repeat rate',
                profileTopVenues: 'Top venues',
                profileUpcoming: 'Upcoming shows',
                profileRecent: 'Recent shows',
                profileGallery: 'Gallery',
                profileStatusConfirmed: 'Confirmed',
                profileStatusPending: 'Pending',
                profileTrendUp: 'vs last month',
                profileHours: 'h',
                profileVenueShows: 'shows',
                profileEditSave: 'Save changes',
                profileUploadGallery: 'Upload photo or video',
                profileUploadGalleryHint: 'JPG, PNG, MP4, WebM · max 10 MB',
                profileNoGallery: 'Upload photos or videos to your gallery',
                profileDescription: 'Description',
                profileGenre: 'Music genre',
                profileVenuesHint: 'Separate venues with commas',
            ...
            registroBanda: {
                ...
                hintPassword: 'At least 6 characters. Together with your band name, this will be your marketplace login.',
